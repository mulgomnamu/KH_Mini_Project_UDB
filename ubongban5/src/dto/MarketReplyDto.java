...
public class MarketReplyDto {
	...
	public MarketReplyDto(int seq, String name, String content, String wdate, int del, int bbsseq) {
		super();
		this.seq = seq;
		this.name = name;
	...
	public MarketReplyDto(int seq, String name, String content, String wdate, int del, int bbsseq, int family,
			int parent, int depth, int indent) {
		super();
		this.seq = seq;
		this.name = name;
		this.content = content;
	...
	public String toString() {
		return "MarketReplyDto [seq=" + seq + ", name=" + name + ", content=" + content + ", wdate=" + wdate + ", del="
				+ del + ", bbsseq=" + bbsseq + ", family=" + family + ", parent=" + parent + ", depth=" + depth
				+ ", indent=" + indent + "]";
	}
